            ...
            if not condition_meet:
                ...
                if status == '*':
                    timestamps = found_activities.loc[found_activities['lifecycle:transition'] == 'complete'][
                        'shift:timestamp']
                    #print('\nTimestamp completed log:')
                    #print(timestamps)
                    #print(in_restriction_flex(timestamps, activity_to, 1))

                    if not in_restriction_flex(timestamps, activity_to, 0):
                ...
                timestamps = found_activities.loc[found_activities['lifecycle:transition'] == 'start'][
                        'shift:timestamp']
                #print('\nTimestamp started log:')
                #print(timestamps)
                #print(in_restriction_flex(timestamps, activity_from, 1))
                if not in_restriction_flex(timestamps, activity_from, 0):
